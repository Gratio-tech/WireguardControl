...
### Возможности
 ...
 - Работа с несколькими `.conf`-файлами (интерфейсами) **TESTING**
 - Максимально простой веб-интефрейс, написан на чистом JS без фрэймворков, можно править всё что необходимо прямо на месте
